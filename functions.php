...
function rsc_public_scripts() {
	...
	wp_enqueue_style( 'owl_default', get_template_directory_uri() . 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css', array('jquery'), wp_rand(), 'all' );
